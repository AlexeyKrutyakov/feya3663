...
> Связано: `05-roadmap.md` (Фаза 0), `06-tasks-phase-0-1.md` (декомпозиция), `04-architecture.md` (ADR-001/005).
...
- **Корень монорепо = корень git-репозитория** (`D:\programming\feya3663`). В `docs/06` структура
...
### Завершение
- [ ] Отметить выполненные пункты в `docs/06-tasks-phase-0-1.md` и обновить «Текущий фокус» в `docs/00-README.md`.
...
4. По мере выполнения — отмечать чек-боксы здесь и в `docs/06`.
