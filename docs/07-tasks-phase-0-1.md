...
>
> ⚠️ **Гранула работы (обновлено 2026-08-08):** фазы здесь — это **группировка для планирования**, а не единица PR. Каждая задача (напр. 0.4 web, 0.5 docker-compose, 0.6 CI) идёт **отдельной веткой и PR**. См. `08-git-workflow.md` («единица = фича/задача, не фаза»).
